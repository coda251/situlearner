package com.coda.situlearner.feature.word.list.util

import androidx.compose.runtime.Composable
import androidx.compose.ui.res.stringResource
import com.coda.situlearner.feature.word.list.R
...
internal fun formatInstant(
    ...
    return when {
        ...
        inputDate == currentDate.minus(DatePeriod(days = 1)) -> {
            stringResource(R.string.word_list_screen_yesterday)
        }

        inputDate.isInSameWeekAs(currentDate) -> {
            when (inputDate.dayOfWeek) {
                DayOfWeek.MONDAY -> stringResource(R.string.word_list_screen_monday)
                DayOfWeek.TUESDAY -> stringResource(R.string.word_list_screen_tuesday)
                DayOfWeek.WEDNESDAY -> stringResource(R.string.word_list_screen_wednesday)
                DayOfWeek.THURSDAY -> stringResource(R.string.word_list_screen_thursday)
                DayOfWeek.FRIDAY -> stringResource(R.string.word_list_screen_friday)
                DayOfWeek.SATURDAY -> stringResource(R.string.word_list_screen_saturday)
                DayOfWeek.SUNDAY -> stringResource(R.string.word_list_screen_sunday)
            }
        }
