...
private fun WordSortOptionBoard(
    ...
    Column {
        ListItem(
            headlineContent = {
                Text(
                    text = stringResource(R.string.word_list_screen_sort)
                )
            },
        ...
        ListItem(
            ...
            leadingContent = {
                Text(
                    text = stringResource(R.string.word_list_screen_sort_mode)
                )
            },
            colors = ListItemDefaults.colors(containerColor = Color.Transparent)
        )
        ...
        ListItem(
            ...
            leadingContent = {
                Text(
                    text = stringResource(R.string.word_list_screen_word_sort_by)
                )
            },
            colors = ListItemDefaults.colors(containerColor = Color.Transparent)
        )
...
private fun SortMode.asText() = when (this) {
    SortMode.Ascending -> stringResource(R.string.word_list_screen_sort_mode_ascending)
    SortMode.Descending -> stringResource(R.string.word_list_screen_sort_mode_descending)
}
