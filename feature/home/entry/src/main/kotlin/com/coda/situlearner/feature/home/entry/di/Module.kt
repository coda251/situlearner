...
import com.coda.situlearner.feature.home.settings.player.di.homeSettingsPlayerModule
import com.coda.situlearner.feature.home.settings.theme.di.homeSettingsThemeModule
...
val homeEntryModules = listOf(
    ...
    homeSettingsPlayerModule,
    homeSettingsThemeModule,
    homeSettingsWordModule,
    homeWordBookModule,
    homeWordEntryModule,
)